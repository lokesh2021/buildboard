    ...
    <div className="w-full max-w-[420px] flex flex-col form-fade-in">
      ...
      <div className="grid grid-cols-2 gap-4 mb-8">
        <button
          ...
          className="flex items-center justify-center gap-3 py-3 px-4 bg-surface-container border border-outline-variant/10 rounded-lg opacity-50 cursor-not-allowed"
        >
