...
export default function ProjectSidebar({
  ...
  return (
    <>
      ...
      <aside
        className={`h-screen w-64 fixed left-0 top-0 z-50 bg-surface-container-low flex flex-col border-r border-outline-variant/10 text-sm font-medium tracking-tight overflow-y-auto
      ...
      >
        <div className="flex flex-col h-full py-6 px-3">
          ...
          <div className="mb-6 px-2">
            <div className="flex items-center gap-3 mb-5">
              ...
              <div className="flex-1 min-w-0">
                <h2 className="text-base font-bold tracking-tight text-primary leading-tight truncate">
              ...
              <button
                onClick={onClose}
                className="md:hidden p-1 text-on-surface-variant hover:text-on-surface rounded-lg hover:bg-surface-container transition-colors flex-shrink-0"
              >
              ...
              {switcherOpen && (
                <div className="absolute left-0 right-0 top-full mt-1 z-50 bg-surface-container-lowest rounded-lg shadow-lg ring-1 ring-outline-variant/15 py-1 overflow-hidden">
                    ...
                    projects.map((p) => {
                      ...
                      return (
                        <button
                          ...
                          onClick={() => {
                            setSwitcherOpen(false)
                            if (!isCurrent) handleNavClick(() => navigate(`/project/${p.id}/documents`))
                          }}
                  ...
                  <div className="border-t border-outline-variant/10 mt-1 pt-1">
                    <button
                      onClick={() => { setSwitcherOpen(false); handleNavClick(() => navigate('/dashboard')) }}
          ...
          <nav className="flex-1 space-y-5">
            ...
            {/* Project nav — only shown when inside a project */}
            {!isDashboard && (
              <div className="space-y-1">
                <button
                  onClick={() => handleNavClick(() => navigate(`/project/${project.id}`))}
                ...
                >
                  ...
                  <span className={activeSection === 'overview' ? 'font-semibold' : ''}>Overview</span>
                </button>
              </div>
            )}
                    ...
                    <div key={dept.id} className="space-y-0.5">
                      ...
                      {isExpanded && (
                        <div className="ml-8 space-y-0.5 border-l border-outline-variant/20 pl-3 mt-1 pb-1">
                          <button
                            onClick={() => handleNavClick(() => navigate(`/project/${project.id}/documents`))}
                          ...
                          <button
                            onClick={() => handleNavClick(() => navigate(`/project/${project.id}/trackers`))}
